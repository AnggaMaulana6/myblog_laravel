...
@section('container')    
    ...
    @if ($posts->count())
        <div class="card mb-3">
            ...
            <h3 class="card-title">
                <a href="/posts/{{ $posts[0]->slug }}" class="text-decortion-none text-dark">{{ $posts[0]->title }}</a>
            </h3>
            <p>
                <small class="text-muted">
                    By. <a href="/posts?author={{ $posts[0]->author->username }}">{{ $posts[0]->author->username }}</a> in <a href="/posts?category={{ $posts[0]->category->slug }}" class="text-decoration-none">{{ $posts[0]->category->name }}</a>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card"> 
                        ...
                        <div class="card-body">
                            ...
                            <p>
                                <small class="text-muted">
                                    By. <a href="/posts?author={{ $post->author->username }}">{{ $post->author->username }}</a>
